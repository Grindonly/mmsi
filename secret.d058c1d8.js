 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&g(t.buffer)},isString:y,isNumber:b,isBoolean:t=>!0===t||!1===t,isObject:w,isPlainObject:E,isUndefined:d,isDate:A,isFile:v,isBlob:O,isRegExp:L,isFunction:m,isStream:t=>w(t)&&m(t.pipe),isURLSearchParams:R,isTypedArray:C,isFileList:B,forEach:S,merge:/**
 ...
 *
 * @returns {boolean}
 */function(t){return!!(t&&m(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{let e=Array(10),r=(t,n)=>{if(w(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[n]=t;let o=p(t)?[]:{};return S(t,(t,e)=>{let i=r(t,n+1);d(i)||(o[e]=i)}),e[n]=void 0,o}}return t};return r(t,0)},isAsyncFn:D,isThenable:t=>t&&(w(t)||m(t))&&m(t.then)&&m(t.catch)};/**
...
return{get:()=>t,set(t){this[r]=t}}}),k.freezeMethods(t4),k.inherits(t8,M,{__CANCEL__:!0});var t7=tG.isStandardBrowserEnv?{write:function(t,e,r,n,o,i){let s=[];s.push(t+"="+encodeURIComponent(e)),k.isNumber(r)&&s.push("expires="+new Date(r).toGMTString()),k.isString(n)&&s.push("path="+n),k.isString(o)&&s.push("domain="+o),!0===i&&s.push("secure"),document.cookie=s.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function t9(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t:e}var et=tG.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
t.data=t3.call(t,t.transformRequest),-1!==["post","put","patch"].indexOf(t.method)&&t.headers.setContentType("application/x-www-form-urlencoded",!1);let e=eu.getAdapter(t.adapter||tY.adapter);return e(t).then(function(e){return ef(t),// Transform response data
e.data=t3.call(t,t.transformResponse,e),e.headers=t4.from(e.headers),e},function(e){return!t5(e)&&(ef(t),e&&e.response&&(e.response.data=t3.call(t,t.transformResponse,e.response),e.response.headers=t4.from(e.response.headers))),Promise.reject(e)})}const ec=t=>t instanceof t4?t.toJSON():t;function eh(t,e){// eslint-disable-next-line no-param-reassign
...
eA.CanceledError=t8,eA.CancelToken=ew,eA.isCancel=t5,eA.VERSION=ep,eA.toFormData=tj,// Expose AxiosError class
